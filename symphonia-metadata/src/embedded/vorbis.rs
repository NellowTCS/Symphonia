...
static VORBIS_COMMENT_MAP: OnceBox<RawTagParserMap> = OnceBox::new();

fn init_vorbis_comment_map() -> Box<RawTagParserMap> {
            ...
            Ok(parsed) => match parsed {
                ParsedComment::Tag(raw) => {
                    ...
                    builder.add_mapped_tags(
                        raw,
                        VORBIS_COMMENT_MAP.get_or_init(init_vorbis_comment_map),
                    );
                }
